      ...
      <div className="bg-gray-50">
        ...
        <div className="secondary-bg">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
            <h1 className="text-4xl font-extrabold tracking-tight primary-text-color sm:text-5xl lg:text-6xl">
              About NutriGen Bot
            </h1>
            <p className="mt-6 max-w-3xl mx-auto text-xl primary-text-color text-opacity-90">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="prose prose-lg prose-emerald mx-auto">
            <h2 className="text-3xl font-bold primary-text-color mb-6">Our Mission</h2>
            ...
            <div className="my-12 bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="p-8 secondary-bg flex flex-col items-center text-center">
                  <div className="rounded-full primary-bg p-3 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 secondary-text-color" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h2 className="text-3xl font-bold primary-text-color mt-12 mb-6">How It Works</h2>
            <p className="text-gray-600">
            ...
            <div className="my-12 secondary-bg rounded-lg shadow-lg overflow-hidden">
              <div className="px-6 py-8 md:p-10 primary-bg secondary-text-color shadow-lg">
                <h2 className="text-3xl font-bold mb-4">Our Features</h2>
                <p className="secondary-text-color text-lg">
              ...
              <div className="px-6 py-8 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold text-black mb-2 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 primary-text-color mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="my-12 secondary-bg from-emerald-50 to-green-50 rounded-lg p-8 flex flex-col items-center text-center shadow-md">
              <h2 className="text-3xl font-bold primary-text-color mb-6">Get Started Today</h2>
              ...
              <Link 
                href="/auth/signup" 
                className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white btn-primary transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
              >
                Sign Up Now
              </Link>
            </div>

            <h2 className="text-3xl font-bold primary-text-color mt-12 mb-6">Data Privacy</h2>
            <p className="text-gray-600">
            ...
            <p className="text-gray-600 mt-4">
              ...
              <Link href="/privacy" className="primary-text-color hover:text-emerald-700">
                Privacy Policy
              </Link>.
            </p>
            
            <div className="mt-8 secondary-bg p-6 rounded-lg shadow-md border border-emerald-100">
              <div className="flex items-center space-x-2 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 primary-text-color" fill="none" viewBox="0 0 24 24" stroke="currentColor">
